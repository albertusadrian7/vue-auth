    ...
    <div class="px-4 pt-6">
        ...
        <div v-if="authStore.user">
            <div
                ...
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Hi, {{ authStore.user.name
                }}
                </h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">{{ authStore.user.email }}</p>
            </div>
            <div
                ...
                <div class="w-full mb-1">
                    <div class="sm:flex">
                        ...
                        <FormModal :modalActive="modalActive" @close-modal="toggleModal"></FormModal>
                    </div>
                </div>
            </div>
